// Animated driving-car loader for route-loading states. Pure CSS (animations
// live in globals.css). Drop it anywhere; pass a className to control height.
