...
function RenterSignupForm() {
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 p-6">
      <Link href="/signup" className="inline-flex items-center gap-1 text-slate-500 hover:text-slate-900 text-xs mb-4">
        <ArrowLeft size={12} /> Back
      </Link>

      <h1 className="text-slate-900 font-bold text-xl mb-1">Create your renter account</h1>
      ...
      <p className="text-slate-500 text-xs mt-1 mb-6">
        Want to rent out a vehicle instead?{" "}
        <Link href="/signup?intent=provider" className="text-blue-600 hover:text-blue-500 font-medium">
          List a vehicle
        </Link>
      </p>
