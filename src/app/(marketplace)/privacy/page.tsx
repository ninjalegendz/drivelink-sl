    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <article className="space-y-6 text-slate-700 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p className="font-medium text-slate-900 mt-3 mb-1">From renters:</p>
          ...
          <p className="font-medium text-slate-900 mt-4 mb-1">From agencies:</p>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <p className="font-medium text-slate-900 mt-4 mb-1">Automatically when you visit the site:</p>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <section>
          ...
          <p>
            Privacy questions or data requests: <span className="font-mono">{siteConfig.privacyEmail}</span>.
            General support: <span className="font-mono">{siteConfig.supportEmail}</span> or via the
